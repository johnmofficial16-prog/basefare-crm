      ...
      if (parsed) {
        ...
        return `<div class="seg-card p-3 bg-amber-50 border border-amber-200 rounded-xl">
          <div class="grid grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_auto_auto] gap-2 items-end">
            <div><label class="block text-[9px] font-bold text-amber-700 uppercase mb-1">Airline</label><input type="text" value="${_esc(seg.airline_iata)}" placeholder="AA or American" class="w-full border border-amber-300 rounded px-2 py-1 text-xs font-mono bg-white uppercase" oninput="flightMgr._updateSeg('${group}',${i},'airline_iata',this.value.toUpperCase())"></div>
            <div><label class="block text-[9px] font-bold text-amber-700 uppercase mb-1">Flight #</label><input type="text" value="${_esc(seg.flight_no)}" placeholder="AA123" class="w-full border border-amber-300 rounded px-2 py-1 text-xs font-mono bg-white" oninput="flightMgr._updateSeg('${group}',${i},'flight_no',this.value)"></div>
